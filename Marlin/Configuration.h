...
#define STRING_CONFIG_H_AUTHOR "Juha Koljonen" // Who made the changes.
...
#define CUSTOM_MENDEL_NAME "ASE TAZ 4"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100.5,100.5,400,800} // default steps per unit for Ultimaker
